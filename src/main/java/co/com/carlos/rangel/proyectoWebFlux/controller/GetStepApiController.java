...
public class GetStepApiController {
    ...
    public GetStepApiController(StepOneService stepOneService, StepTwoService stepTwoService, StepThreeService stepThreeService, CircuitBreakerRegistry circuitBreakerRegistry, RetryRegistry retryRegistry, WebHookService webHookService) {
